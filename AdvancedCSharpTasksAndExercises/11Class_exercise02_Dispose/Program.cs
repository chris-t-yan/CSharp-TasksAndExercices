using _11Class_exercise02_Dispose;
using System;
using System.IO;

namespace _11Class_exercise02_Disposing
{
    ...
    class Program
    {
        ...
        public static void WriteAndReadInFileExample()
        {
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("There was problem in the writing file");
            ...
            catch (Exception ex)
            {
                ...
                Console.WriteLine("There was problem in the reading file");
                Console.WriteLine(ex.Message);
            }
        }
